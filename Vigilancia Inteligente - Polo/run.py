...
extProc = sp.Popen(['python','//home/ia1/cv/Proyectos/Vigilancia-Inteligente/Vigilancia Inteligente - Polo/model.py']) # ejecuta myPyScript.py 
...
while True:
    ...
    if hour>=19 or hour<=4:
        if sp.Popen.poll(extProc) != None:
            extProc = sp.Popen(['python','/home/ia1/cv/Proyectos/Vigilancia-Inteligente/Vigilancia Inteligente - Polo/model.py'])
